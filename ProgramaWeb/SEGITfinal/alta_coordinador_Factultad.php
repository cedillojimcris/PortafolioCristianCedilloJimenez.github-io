            ...
            <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
                ...
                <div class="left-agileits-w3layouts same">
                    ...
                    <div class="gaps form-group">
                        ...
                        <input onkeyup="limpiarletras(this)" onchange="limpiarletras(this)" type="text"
                            name="apellidoPaCF" attern="([a-zA-Z]*+[ ]+[a-zA-Z]*)"
                            placeholder="Escribe un apellido valido" required onpaste="return false"/>
                    </div>
                    <div class="gaps form-group">
                        <p>Apellido Materno:</p>
                        <input onkeyup="limpiarletras(this)" onchange="limpiarletras(this)" type="text"
                            name="apellidoMaCF" attern="([a-zA-Z]*+[ ]+[a-zA-Z]*)"
                            placeholder="Escribe un apellido valido" required onpaste="return false" />
                    </div>
                </div>
                ...
                <div class="right-agileinfo same">
                    ...
                    <div class="gaps form-group">
                        ...
                        <input onkeyup="limpiarNumero(this)" onchange="limpiarNumero(this)" type="tel" name="telefonoCF"
                            minlength="10" MAXLENGTH=10 pattern="[0-9]{10}" placeholder="Se compone de 10 dígitos"
                            required="" />
                    </div>
                    <div class="gaps form-group">
