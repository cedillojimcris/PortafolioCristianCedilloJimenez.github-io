                ...
                <div class="right-agileinfo same">
                    ...
                    <div class="gaps form-group">
                        ...
                        <select class="form-control" name="tipoProblema" required>
                            ...
                            <option value="Perdida de un ser querido">Perdida de un ser querido</option>
    ...
    <section class="sec-inf">
        <div align="center">
            <footer id="footer">
                ...
                <p>Lìnea de Atencòn Psicològica UAEMex: </p>
                <P>Facebook: @facicocespiUAEM</P>
                <p>Telèfono: 7224628287</p>
                <p>&copy; Dirección Cerro de Coatepec S/N, Ciudad Universitaria</p>
                <P> Toluca, Edo. de México C.P. 50110 </P>
                <P> Fax: 215 47 44, Teléfonos: (01 722) 214 02 50<a
                        href="http://www.fca.uaemex.mx/alumnos/tutoria.html"> Tutoria UAEMex</a>.</p>
